      ...
      <section className="py-32 px-6">
         <div className="max-w-4xl mx-auto bg-eneo-gradient rounded-[3rem] p-12 lg:p-20 text-center text-white relative overflow-hidden drive-shadow">
            ...
            <div className="relative z-10 space-y-8">
               ...
               <p className="text-violet-100 font-medium text-lg max-w-xl mx-auto opacity-99">Rejoignez des centaines de professionnels qui font confiance à Eneo File pour leur quotidien.</p>
               <button 
                 onClick={handleStart}
